...
const ENTITY_FEEDS = {
  ...
  'intrinsic_innovation_rss': process.env.INTRINSIC_INNOVATION_RSS,
  ...
  'pacific_gas_electric_rss': process.env.PACIFIC_GAS_ELECTRIC_RSS,
  'pantera_capital_rss': process.env.PANTERA_CAPITAL_RSS,
  'peterson_solutions_fund_rss': process.env.PETERSON_SOLUTIONS_FUND_RSS,
